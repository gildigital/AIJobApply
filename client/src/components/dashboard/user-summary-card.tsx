...
export default function UserSummaryCard() {
  ...
  // Handler to scroll to the AutoApplyCard
  const handleScrollToAutoApply = () => {
    const autoApplyCard = document.getElementById("auto-apply-card");
    if (autoApplyCard) {
      autoApplyCard.scrollIntoView({ behavior: "smooth", block: "start" });
    }
  };
      ...
      <Card className="flex-1">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center p-6 text-center text-muted-foreground">
            ...
            <p className="text-sm">
              Please upload your resume to generate a professional summary
            </p>
          </div>
        </CardContent>
      </Card>
    ...
    <Card className="flex-1">
      ...
      <CardContent>
        <div className="rounded-md bg-muted/50 p-4 text-card-foreground">
          <p className="text-md font-medium italic leading-relaxed">
            "{data.userSummary}"
          </p>
        </div>
      </CardContent>
      <CardFooter className="pt-2">
        ...
        {isPremium && (
          <Button
            ...
            size="lg"
            onClick={handleScrollToAutoApply}
          >
